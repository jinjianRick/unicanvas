...
if __name__ == "__main__":
    ...
    try:
        ...
        #print('aa', opt.init_ctx)
        #print('bb', type(opt.init_ctx))

        config.model.params.init_ctx = opt.init_ctx
        config.model.params.ctx_end_init = opt.ctx_end_init

        config.model.params.figure_num=opt.figure_num
        ...
        print('kkk', trainer_kwargs)
        print('lll', trainer_opt)
        ...
        config.data.params.train.params.tokens = json.loads(opt.token_pos)
        config.data.params.validation.params.tokens = json.loads(opt.token_pos)
        ...
        print('lll', config.data.params.batch_size)
