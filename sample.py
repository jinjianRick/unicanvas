...
def main():
    ...
    print('aa', length_custom)
    print('bb', length_ldm)
    print('cc', mask_custom)
    print('dd', mask_ldm)
    print('tokens', tokens)
    ...
    extra_info = {'length_ldm': length_ldm, 'length_custom': length_custom, 'mask_ldm': mask_ldm, 'mask_custom': mask_custom, 'b_edit': opt.b_edit, 'bl_path': opt.bl_path, 'bk_opt':opt.bk_opt, 'cor_dict':opt.cor_dict}
